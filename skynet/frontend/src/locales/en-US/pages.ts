export default {
  ...
  'pages.notification.table.level.info': 'Info',
  'pages.notification.table.level.success': 'Success',
  'pages.notification.table.level.warning': 'Warning',
  'pages.notification.table.level.error': 'Error',
  ...
  'pages.plugin.table.status.unload': 'Unload',
  'pages.plugin.table.status.pending.disable': 'Pending Disable',
  'pages.plugin.table.status.pending.enable': 'Pending Enable',
  'pages.plugin.table.status.enable': 'Enable',
